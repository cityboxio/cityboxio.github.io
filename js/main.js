...
var options = {
	...
	template: {
		...
		method: function(value, item) {
			...
			return "</br>" + 
				"</br>" + 
				"<b>" + value + "</b>" + ", " + item.subcountry + ", " + item.country + "&nbsp;&nbsp;" + '<img src="img/flags/'+ flags[item.country].toLowerCase() + '.svg" alt="flag" style="width: 40px; float: right;   box-shadow: -1px -1px 10px -2px rgba(0, 0, 0, 0.5);">'+
				"</br>" +
				"</br>" +
				"</br>"  
			;
